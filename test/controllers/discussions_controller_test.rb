...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { campaign_id: @discussion.campaign_id, created_by: @discussion.created_by, title: @discussion.title } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { campaign_id: @discussion.campaign_id, created_by: @discussion.created_by, title: @discussion.title } }
